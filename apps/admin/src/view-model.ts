...
/** Disciplines the admin can validate against (matching the FINA DD table). */
...
/**
 * Parse a free-text dive sheet — one dive per line, "code position"
 * (e.g. "5253 B") — into structured items. Tolerant of extra whitespace.
 */
